...
export default async function CategoriesItems() {
  ...
  return (
    ...
    <div>
      <h1 className="text-center text-xl  md:text-3xl lg:text-4xl font-bold tracking-wide pt-4  px-1 max-w-xl w-44 sm:w-52 md:w-60 lg:w-72 rounded-xl mx-auto bg-gray-200 pd-4 my-4 text-gray-800 h-18">Categories</h1>
        ...
        {productCategories?.map((item, i) => {
          return (
            ...
            <Link key={i}
              ...
              px-6 py-5 gap-6 text-blue-800 font-bold 
